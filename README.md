...
## For detailed instructions to use anygrasp with Fanka Panda (Darko project throwing demo), please refer to [this GitHub page](https://github.com/Brunoadc/anygrasp_sdk/blob/main/grasp_robot).
